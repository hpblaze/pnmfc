...
file_directory = "/home/hp/dumux/harsha_pnm/build-cmake/appl/2p_magic/time_1sec/"
pvd_file_path = os.path.join(file_directory, "2p_magic_reg_time_1sec.pvd")
...
if timesteps:
    ...
    file_paths = [os.path.join(file_directory, f"2p_magic_reg_time_1sec-{i:05d}.vtp") for i in range(num_vtp_files)]
    ...
    for idx, pore_index in enumerate(pore_indices):
        ...
        ax.set_ylabel('Local S$_w$ [-]', fontsize=12, color='blue')
        ...
        ax.tick_params(axis='y', which='major', direction='out', length=6, width=1, labelsize=10, labelcolor='blue')
        ...
        for i, s_liq_array in enumerate(s_liq_data_arrays):
            marker = 'o'  # Cycle through markers
            color = 'blue'  # Get color from the predefined list
    ...
    subplots_filename = os.path.join(file_directory, "Milestone_subplots_S_liq_with_realtime.png")
