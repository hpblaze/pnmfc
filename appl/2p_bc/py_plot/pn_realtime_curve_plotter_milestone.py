...
file_directory = "/home/hp/dumux/harsha_pnm/build-cmake/appl/2p_magic/2p_magic_float64/"
pvd_file_path = os.path.join(file_directory, "2p_magic_reg_float64.pvd")
...
if timesteps:
    ...
    file_paths = [os.path.join(file_directory, f"2p_magic_reg_float64-{i:05d}.vtp") for i in range(num_vtp_files)]
    ...
    subplots_filename = os.path.join(file_directory, "Milestone_p_gasvsRealtime.png")
