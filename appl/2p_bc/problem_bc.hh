...
public:
    ...
    : ParentType(gridGeometry, spatialParams), prevSol_(xPrev)
    {
        ...
        layerOffset_ = 9; //magic pores offset location 
    }
...
private:
    ...
    bool isMagicPore_(const SubControlVolume& scv) const
    {
        return this->gridGeometry().poreLabel(scv.dofIndex()) ==Labels::magic;
    }
    bool isMagicPore_(const std::size_t dofIdxGlobal) const
    {
        return this->gridGeometry().poreLabel(dofIdxGlobal) ==Labels::magic;
    }
