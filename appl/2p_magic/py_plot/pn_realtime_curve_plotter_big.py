...
file_directory = "/home/hp/dumux/harsha_pnm/build-cmake/appl/2p_magic/GDB_MPL/"
pvd_file_path = os.path.join(file_directory, "2p_magic_GDB_MPL.pvd")
...
if timesteps:
    ...
    file_paths = [os.path.join(file_directory, f"2p_magic_GDB_MPL-{i:05d}.vtp") for i in range(num_vtp_files)]
    ...
    for idx, pore_index in enumerate(pore_indices):
        ...
        ax.set_ylabel('Local p_gas [-]', fontsize=12)
