...
for idx, pore_index in enumerate(pore_indices):
    ...
    ax.set_ylabel('Local P$_c$ [-]', fontsize=12)
    ...
    for i, pc_array in enumerate(pc_data_arrays):
        ...
        ax.plot(file_number, pc_array[pore_index], color=color, marker=marker, markersize=6, label=f'{file_number}')
...
for pore_index in pore_indices:
    ...
    plt.ylabel('Local P$_c$ [-]', fontsize=14)
